...
public:
	...
	GatedPoolParam local_gatedpool_project;
	GatedPoolParam context_gatedpool_project;
...
public:
	...
	void exportCheckGradParams(CheckGrad& checkgrad){
		...
		checkgrad.add(&(context_gatedpool_project._uni_gate_param.W), "context_gatedpool_project.uni.W");
		checkgrad.add(&(context_gatedpool_project._uni_gate_param.b), "context_gatedpool_project.uni.b");
